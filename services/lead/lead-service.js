...
function unlockSnapshot(enquiry, provider, input = {}) {
  return {
    ...
    leadTitle: enquiry.providerRequirementTitle || enquiry.requirementTitle || "",
    leadTitleKey: normalizeSearchText(enquiry.providerRequirementTitle || enquiry.requirementTitle),
